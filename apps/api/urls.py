...
from apps.api.views import UserLoginView,UserLoginMobileView,UserListView,UserDetailView,UserDeleteView,UserUpdateView,UserCreateView,PostsViewset,OtpVerifyViewSet,SecondaryaddView
